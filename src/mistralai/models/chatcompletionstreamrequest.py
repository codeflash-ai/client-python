...
class ChatCompletionStreamRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        ...
        # Precompute the set for intersection once
        fields_set = self.__pydantic_fields_set__  # pylint: disable=no-member

        # Avoid recomputing optional_nullable repeatedly in the loop
        optional_nullable_fields = optional_fields & nullable_fields

        # Avoid unnecessarily copying keys with .pop, use .get only
